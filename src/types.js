...
exports.fraction = () =>
  Object.assign(exports.number(), { minimum: 0, maximum: 1 });

exports.localizedMessage = () => ({
  type: "object",
  required: true,
  properties: { en: exports.string() }
});

exports.webServiceAlert = () =>
  exports.object({
    action: exports.optional(
      exports.object({
...
exports.coin = () =>
  exports.object({
    ...
    config: exports.optional(
      exports.object({
        network: exports.optional(
          exports.enumOf(["bitcoin", "public", "testnet", 1])
        ),
        fees: exports.optional(
          exports.object({
